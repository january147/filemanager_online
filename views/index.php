...
<div id='navigation_wrapper'>
  <div onclick = "home()"><img src="static/imgs/icons/home.png" alt="home" title="主目录" /></div>
  <div onclick = "addFile()"><img src="static/imgs/icons/create_file.png" alt="+file" title="新建文件" /></div>
  <div>
    <!--隐藏域，上传文件begin：-->
    <form id='file_form' style="display:none">
      <input type="file" name="upload_file" id="_file" onchange="uploadFile(this.id)" style="width:1.5rem;height:2.5rem" />
    </form>
    <!--隐藏域，上传文件end：-->
    <label for="_file"style='height:2rem'><img src="static/imgs/icons/upload.png" alt="upload" title="上传" /></label>
  </div>
  <div onclick = "addDir()"><img src="static/imgs/icons/create_dir.png" alt="+dir" title="新建目录" /></div>
  <?php $src = 'static/imgs/icons/paste_'.$clipper.'.png'?>
  <div onclick="_paste()"><img src="<?php echo $src?>" alt="paste" title="粘贴" id="paste" /></div>
  <div onclick = "back()"><img src="static/imgs/icons/back.png" alt="back" title="返回" /></div>
</div>
